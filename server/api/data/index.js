...
router.get('/delete/project/:projectId', auth.hasRole('admin'), controller.removeProject);
router.get('/delete/dataset/:datasetId', auth.hasRole('admin'), controller.removeDataset);
router.get('/delete/orf/:orfId', auth.hasRole('admin'), controller.removeOrf);
